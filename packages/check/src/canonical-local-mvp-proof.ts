...
export async function createCanonicalSyntheticMvpFixture() {
  ...
  const objects = [
    draft(entityId, "entity", { schema: "atlas.entity:v1", entity_id: entityId, type: "organization", name: "Synthetic Canonical Entity", aliases: [], created_at: now, updated_at: now }),
